                        ...
                        <tbody>
                            {
                                ...
                                scholarships.map((scholarship, idx) => (
                                    <tr key={scholarship._id} className="hover:shadow-md">
                                        <td>{idx + 1}</td>
                                        ...
                                        <td>
                                            <Link to={`/dashboard/manageScholarshipDetails/${scholarship._id}`}>
                                                <button className="btn btn-ghost text-lg text-red-500 border-red-200 bg-orange-200">
                                                    <TbListDetails />
                                                </button>
                                            </Link>
                                        </td>
                                        <td>
                                            <Link to={`/dashboard/update/${scholarship._id}`}>
                                                <button className="btn btn-ghost text-lg text-red-500 border-red-200 bg-orange-200">
                                                    <FaEdit />
                                                </button>
                                            </Link>
                                        ...
                                        <td>
                                            <button onClick={() => handleDelete(scholarship)} className="btn btn-ghost text-lg text-red-500 border-red-200 bg-orange-200">
