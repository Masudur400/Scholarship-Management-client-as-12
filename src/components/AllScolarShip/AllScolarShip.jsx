...
const AllScolarShip = () => {
    ...
    const { data: scholarshipsa = [], isPending } = useQuery({
    ...
    useEffect(() => {
        ...
        if (query === '') {
            ...
            const filterData = scholarshipsa?.filter(item => 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {
                    ...
                    filteredData.map(scholarship => <Scholarship key={scholarship._id} scholarship={scholarship} />) :
